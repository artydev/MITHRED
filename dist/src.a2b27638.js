...
},{}],"src/components/inputImage.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["d none"]);
...
var eltById = function eltById(id) {
...
var InputImage = function InputImage() {
  var view = function view() {
    return (0, _mithril.default)(div, [(0, _mithril.default)("input" + (0, _bss.default)(_templateObject()), {
      type: "file",
      id: "selectimage",
      onchange: function onchange(e) {
        return insertImage(e.target.files[0]);
      }
...
},{"mithril":"node_modules/mithril/index.js","bss":"node_modules/bss/bss.esm.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

var _mithril = _interopRequireDefault(require("mithril"));

var _inputImage = require("./components/inputImage");
...
var GlobStyle = css(_templateObject());
var EditorStyle = css(_templateObject2());
var ToolbarStyle = css(_templateObject3());
var EditPaneStyle = css(_templateObject4());
var AllStyles = [(0, _mithril.default)("style", GlobStyle), (0, _mithril.default)("style", EditorStyle), (0, _mithril.default)("style", ToolbarStyle), (0, _mithril.default)("style", EditPaneStyle)];

var Toolbar = function Toolbar() {
  var view = function view() {
    return (0, _mithril.default)(".toolbar", (0, _mithril.default)(_inputImage.InputImage));
  };
...
var EditPane = function EditPane() {
  var view = function view() {
    return (0, _mithril.default)(".editPane", {
      contenteditable: true
    }, [_mithril.default.trust("<img id='insert' />")]);
  };
...
var Editor = function Editor() {
  var view = function view() {
    return (0, _mithril.default)(".editor", [(0, _mithril.default)(Toolbar), (0, _mithril.default)(EditPane)]);
  };
...
var App = function App() {
  var view = function view() {
    return [AllStyles, (0, _mithril.default)(Editor)];
  };
...
_mithril.default.mount(editor, App);
/*
// Notes
...
*/
},{"mithril":"node_modules/mithril/index.js","./components/inputImage":"src/components/inputImage.js"}],"../../../../Users/sdidio-ccrf/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3442" + '/');
...
},{}]},{},["../../../../Users/sdidio-ccrf/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","src/index.js"], null)
